...
import com.example.shopshoes.server.entity.*;
import com.example.shopshoes.server.infrastructure.constant.*;
...
public class BillServiceImpl implements BillService {
    ...
    public Bill createBillCustomerOnlineRequest(CreateBillCustomerOnlineRequest request) {
        ...
        System.out.println("Check code bill " + bill.getCode());
        System.out.println("Check bill" + bill);
        billRepository.save(bill);
        System.out.println("Check id " + bill.getId());
        ...
        System.out.println("Bill Create User" + bill.getId());
    ...
    @Override
    public List<Bill> findByPhoneNumber(String phoneNumber) {
    ...
    public void sendMail(InvoiceResponse invoice, String url, String email) {
        System.out.println("Check function send mail");
