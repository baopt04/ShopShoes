        ...
        <Menu theme="dark" mode="inline" selectedKeys={selectedKey}>
          ...
          {isAdmin && (
            <SubMenu
              key="8"
              icon={
                <FontAwesomeIcon icon={faTicket} style={{ color: "white" }} />
              }
              title="Giảm Giá"
            >
              ...
              <Menu.Item key="/promotion-management">
                <Link to="/promotion-management">Giảm Giá Sản Phẩm</Link>
              </Menu.Item>
            </SubMenu>
          )}
          ...
          <SubMenu
            key="7"
            icon={<FontAwesomeIcon icon={faUsers} style={{ color: "white" }} />}
          ...
          {isAdmin && (
            <Menu.Item
              ...
              className="menu-item"
              icon={
                <FontAwesomeIcon icon={faChartPie} style={{ color: "white" }} />
              }
            >
