...
const CreateProductManagment = () => {
  ...
  const columns = [
    ...
    {
      title: <div style={{ textAlign: "center" }}>Ảnh sản phẩm</div>,
      dataIndex: "color",
      key: "color",
      width: "100%",
            ...
            <Row justify={"center"}>
              <Col span={11}>
                <Card style={{ height: "565px" }}>
                  <h2 style={{ marginBottom: "30px" }}>Thông tin sản phẩm</h2>
                  <Form.Item
                    label="Tên sản phẩm"
                    name="productId"
              ...
              <Col span={13}>
                <Card style={{ height: "565px" }}>
                  <h2 style={{ marginBottom: "30px" }}>Thuộc tính sản phẩm</h2>
                          ...
                          <Form.Item>
                            <Tooltip title="Thêm thương hiệu">
                              <Button
                                ...
                                style={{ height: 37, marginLeft: "5px" }}
                      ...
                      <div style={{ display: "flex", flexWrap: "wrap" }}>
                        {listSizeAdd.map((item, index) => (
                          <Button
                            ...
                            onClick={() =>
                              handleDeleteSize(index, item.nameSize)
                            }
                          >
                            <span
                              style={{ fontWeight: "bold" }}
