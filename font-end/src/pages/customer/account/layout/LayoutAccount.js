...
function LayoutAccount({ children }) {
  ...
  const category = [
    ...
    // },
    {
      ...
      onClick: logout,
      icon: (
        <FontAwesomeIcon icon={faCircleXmark} style={{ color: "#1677FF" }} />
      ),
    },
  ];
  return (
    <React.Fragment>
      <div className="layout-title">
        <p>
          <a href="/home" style={{textDecoration: "none"}}>Trang Chủ</a> | <a href="/profile" style={{textDecoration: "none"}}>Thành Viên</a>{" "}
        </p>
      </div>
                  ...
                  <div className="box-child-category">
                    {item.children.map((itemChild, indexChild) => (
                      <div
                        ...
                        key={indexChild}
                        style={{
                          color: idChild === itemChild.id ? "#ff4400" : "gray",
                        }}
                        onClick={() => {
