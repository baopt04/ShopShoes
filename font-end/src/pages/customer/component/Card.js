          ...
          <Row justify="center">
            ...
            >
              ...
              <div className="price-product">
                {" "}
                <span style={{ color: "black" }}>Giá sản phẩm: </span>
              ...
              <div>
                <div style={{ marginBottom: "10px", color: "black" }}>
                  <span style={{ fontSize: "18px" }}>Sản phẩm còn lại: </span>
                  <span style={{ color: "#87cefa", fontSize: "15px" }}>
                    {detailProduct.quantity} sản phẩm
                  </span>
                </div>
              </div>
              <div className="add-to-card">
                <span className="quantity-buy">Số lượng muốn mua: </span>
                <InputNumber
